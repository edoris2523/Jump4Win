...
namespace Prototype.NetworkLobby
{
    ...
    {
        static Color[] Colors = new Color[] { Color.white, Color.red, Color.cyan, Color.yellow };
        ...
        {
			p1Btn.onClick.AddListener (delegate {AvatarPicker (p1Btn.name);});
			p2Btn.onClick.AddListener (delegate {AvatarPicker (p2Btn.name);});
			p3Btn.onClick.AddListener (delegate {AvatarPicker (p3Btn.name);});
			p4Btn.onClick.AddListener (delegate {AvatarPicker (p4Btn.name);});
